...
## Corpus Check
- 27 files · ~25,388 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 174 nodes · 179 edges · 22 communities (15 shown, 7 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 1% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.84)
...
Cohesion: 0.08
Nodes (27): EcosystemIntro(), ORBIT_ICONS, ElectricBorder(), hexToRgba(), Footer(), Navbar(), TABS, AUDIENCES (+19 more)
