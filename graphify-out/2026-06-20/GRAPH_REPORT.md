# Graph Report - DB_ECOSYSTEM  (2026-06-20)

## Corpus Check
- 24 files · ~17,061 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 159 nodes · 151 edges · 22 communities (15 shown, 7 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 1% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.84)
...
8. `Digital Broker` - 5 edges
9. `Supaste Clipboard History Manager for Mac` - 5 edges
10. `scripts` - 4 edges
...
Cohesion: 0.12
Nodes (15): EcosystemIntro(), ORBIT_ICONS, ElectricBorder(), hexToRgba(), Navbar(), TABS, BENEFITS, DBAssets() (+7 more)
